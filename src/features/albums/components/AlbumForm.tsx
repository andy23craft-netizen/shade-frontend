...
function AlbumVocabularyPicker({ label, options, selectedIds, onChange, onAdd }: { label: string; options: Array<{ id: string; name: string }>; selectedIds: string[]; onChange: (ids: string[]) => void; onAdd: () => void }) {
