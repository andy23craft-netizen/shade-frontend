...
export function AlbumLoansPage() {
    ...
    if (loans.length === 0) return <section className="route-page album-loans-page"><h1 tabIndex={-1}>Album Loans</h1><EmptyState title="No album loan history yet."><p>Albums that are checked out will appear in this ledger.</p><AppLink to="/albums">Browse the Bins</AppLink></EmptyState></section>
