...
export type SiteReadOnlyRead = Schemas['SiteReadOnlyRead']
export type SiteReadOnlyUpdate = Schemas['SiteReadOnlyUpdate']
export type HouseholdProfileCreate = Schemas['HouseholdProfileCreate']
export type HouseholdProfileDelete = Schemas['HouseholdProfileDelete']
export type HouseholdProfileList = Schemas['HouseholdProfileList']
export type HouseholdProfileRead = Schemas['HouseholdProfileRead']
export type HouseholdProfileUpdate = Schemas['HouseholdProfileUpdate']
