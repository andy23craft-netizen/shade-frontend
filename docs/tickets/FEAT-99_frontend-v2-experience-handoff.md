...
Coordinate remaining frontend-owned V2 behavior across PLAN-02 multi-tenancy, PLAN-03 books, and the album tickets
without adding backend preference or draft-session models.

## Slices and dependencies

1. PLAN-02 guided setup wizard using FEAT-25, canonical shelves, book Build Mode, and FEAT-28 album Bulk Add.
...
6. One accessible visual identity per shipped media area, plus PLAN-02's lightweight per-library palette/personality
